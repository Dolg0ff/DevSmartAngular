...
import { HostDashboardComponentContact } from './dashboard-contact/host-dashboard-contact.component';
        ...
        RouterModule.forChild([
            {
                ...
                children: [
                    ...
                    { path: 'hostDashboardContact', component: HostDashboardComponentContact, data: { permission: 'Pages.Administration.Host.DashboardContact' } },
