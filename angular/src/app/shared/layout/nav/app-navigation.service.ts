...
export class AppNavigationService {
    ...
    getMenu(): AppMenu {
        return new AppMenu('MainMenu', 'MainMenu', [
            new AppMenuItem('Contact', 'Pages.Administration.Host.Dashboard', 'flaticon-line-graph', '/app/admin/hostDashboard'),
            new AppMenuItem('Agents', 'Pages.Administration.Host.Dashboard', 'flaticon-line-graph', '/app/admin/Agents'),
            new AppMenuItem('Settings', 'Pages.Administration.Host.Dashboard', 'flaticon-line-graph', '/app/admin/Settings'),
            new AppMenuItem('Subscription', 'Pages.Administration.Host.Dashboard', 'flaticon-line-graph', '/app/admin/Subscription'),
